...
function emptyall(){
    ...
    submiterrGo.empty()
    submitokGo.empty()
    idpicitem1.attr("src", "/static/images/desktop-front-side.png")
    idpicitem2.attr("src", "/static/images/desktop-back-side.png")
}
//验证
$(document).ready(function (e) {
    ...
    $("#submit").click(function(el){
        ...
        var cardnum=idcardnum.val()
        if (cardnum==="") {
            submiterrGo.html("身份证号空") 
            return false
        }
        var cardname=idcardname.val()
        if (cardname==="") {
