...
func InitLogisticsModel() {
	...
	allmodels[names.LOGISTICS] = &logistics.Logistics{models.NewModel("aq_logistics", false)}
	allmodels[names.LOGISTICS_TASK] = &logistics.LogisticsTask{models.NewModel("aq_logistics_task", false)}
